    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-surface-elevated border-b border-border">
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-16 md:py-20 text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight">
            About Unit Convertor
          </h1>
          <p className="mt-3 text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
            Engineering-grade precision meets everyday simplicity. We built Unit Convertor to be the most reliable unit conversion tool on the web.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 py-12 md:py-16 space-y-12">
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
            We believe that precision matters. A small rounding error can lead to big problems in engineering, medicine, and science. That is why every conversion on Unit Convertor is calculated with the highest degree of accuracy and cross-verified against standard reference data.
          </p>
        </section>
