...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with the UnitPrecise team. Contact us via email at ramdeals0@gmail.com for questions, feedback, or suggestions." },
      { property: "og:title", content: "Contact Us — UnitPrecise" },
      { property: "og:description", content: "Get in touch with the UnitPrecise team. Contact us via email at ramdeals0@gmail.com for questions, feedback, or suggestions." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://myunitconvertor.lovable.app/contact" },
      { name: "twitter:title", content: "Contact Us — UnitPrecise" },
      { name: "twitter:description", content: "Get in touch with the UnitPrecise team. Contact us via email at ramdeals0@gmail.com for questions, feedback, or suggestions." },
    ],
    links: [
