...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "UnitPrecise — Professional Unit Converter & Engineering Tools" },
      ...
      { property: "og:title", content: "UnitPrecise — Professional Unit Converter & Engineering Tools" },
...
const FAQS = [
  { q: "How accurate is the conversion?",
    a: "UnitPrecise uses double-precision floating-point arithmetic and NIST-verified conversion factors. We support up to 12 decimal places of precision for critical technical tasks." },
  { q: "Is this tool free to use?",
    a: "Yes, UnitPrecise is 100% free for students and professional engineers. We sustain the platform through minimal, non-intrusive advertisements." },
...
function HomePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-6 py-8 md:py-12">
      ...
      {/* Why choose */}
      <section className="mb-16">
        <SectionHeader title="Why Choose UnitPrecise?" subtitle="Built for engineers, students, and anyone who needs answers they can trust." centered />
      ...
      {/* FAQ */}
      <section>
        <SectionHeader title="Frequently Asked Questions" subtitle="Answers to common questions about UnitPrecise." centered />
