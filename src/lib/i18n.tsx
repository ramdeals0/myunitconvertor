...
const en: Dict = {
  ...
  "home.why.title": "Why Choose Unit Convertor?",
  ...
  "home.faq.subtitle": "Answers to common questions about Unit Convertor.",
  ...
  "home.faq.a1": "Unit Convertor uses double-precision floating-point arithmetic and NIST-verified conversion factors. We support up to 12 decimal places of precision for critical technical tasks.",
  "home.faq.q2": "Is this tool free to use?",
  "home.faq.a2": "Yes, Unit Convertor is 100% free for students and professional engineers. We sustain the platform through minimal, non-intrusive advertisements.",
  ...
  "home.faq.a4": "Absolutely. Use the contact link in the footer to suggest new categories or specialized units.",
  ...
  "about.h1": "About Unit Convertor",
  "about.lead": "Engineering-grade precision meets everyday simplicity. We built Unit Convertor to be the most reliable unit conversion tool on the web.",
  "about.mission.title": "Our Mission",
  "about.mission.p1": "Unit Convertor was created with a single goal: to make unit conversion effortless, accurate, and accessible to everyone. Whether you are an engineer working on complex calculations, a student learning the sciences, a traveler navigating foreign measurements, or a home cook experimenting with international recipes — we have got you covered.",
  "about.mission.p2": "We believe that precision matters. A small rounding error can lead to big problems in engineering, medicine, and science. That is why every conversion on Unit Convertor is calculated with the highest degree of accuracy and cross-verified against standard reference data.",
  ...
  "about.feedback.text": "We are constantly expanding our converter database based on user requests. If there is a unit or category you would like to see added, we would love to hear from you. Visit our",
  "about.feedback.link": "Contact page",
  "about.feedback.tail": "to send us your suggestions.",

  "contact.badge": "Get in Touch",
  "contact.h1": "Contact Unit Convertor",
  "contact.lead": "Have a question, suggestion, or found an issue? We would love to hear from you.",
  "contact.email.title": "Email Us",
  "contact.email.text": "We read every email and typically reply within 24–48 hours.",

  "privacy.badge": "Privacy",
  "privacy.h1": "Privacy Policy",
  "privacy.lead": "Your privacy is important to us. This policy explains how Unit Convertor handles your data.",
  "privacy.s1.h": "1. Information We Do Not Collect",
  "privacy.s1.t": "Unit Convertor is designed with privacy at its core. We do not require you to create an account, sign in, or provide any personal information to use our tools. All unit conversions are performed entirely in your web browser — no data is sent to our servers for processing.",
  "privacy.s2.h": "2. Contact Form Data",
  "privacy.s2.t": "If you choose to contact us through our Contact page, we collect the name, email address, subject, and message you provide. This information is stored securely in our database and used solely to respond to your inquiry. We do not share this information with third parties or use it for marketing purposes.",
  ...
  "privacy.s5.t": "We take reasonable measures to protect any data you provide through our contact form. However, no method of transmission over the internet is 100% secure, and we cannot guarantee absolute security.",
  ...
  "privacy.s7.t": "If you have any questions about this Privacy Policy, please reach out through our",
  "common.contactPage": "Contact page",
  "common.lastUpdated": "Last updated:",

  "terms.badge": "Legal",
  "terms.h1": "Terms of Service",
  "terms.lead": "Please read these terms carefully before using Unit Convertor.",
  "terms.s1.h": "1. Acceptance of Terms",
  "terms.s1.t": "By accessing or using Unit Convertor, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.",
  "terms.s2.h": "2. Description of Service",
  "terms.s2.t": "Unit Convertor provides free online unit conversion tools. Our service allows you to convert between various units of measurement across multiple categories including length, weight, temperature, volume, area, speed, and more.",
  "terms.s3.h": "3. Use of the Service",
  "terms.s3.t": "You may use Unit Convertor for personal, educational, and professional purposes. You agree not to:",
  ...
  "terms.s4.t": "While we strive for maximum accuracy, Unit Convertor is provided \"as is\" without warranties of any kind. Conversion factors are based on standard reference data, but we cannot guarantee that all conversions are 100% accurate in every context. For critical applications (medical, engineering, financial), please verify results with authoritative sources.",
  "terms.s5.h": "5. Limitation of Liability",
  "terms.s5.t": "To the fullest extent permitted by law, Unit Convertor and its operators shall not be liable for any direct, indirect, incidental, special, or consequential damages arising from your use of or inability to use the service.",
  "terms.s6.h": "6. Intellectual Property",
  "terms.s6.t": "All content on Unit Convertor, including text, graphics, logos, and software, is the property of Unit Convertor or its licensors and is protected by copyright and other intellectual property laws.",
  ...
  "terms.s8.t": "These terms shall be governed by and construed in accordance with the laws applicable in the jurisdiction where Unit Convertor operates, without regard to conflict of law principles.",
  "terms.s9.h": "9. Contact",
  "terms.s9.t": "For questions about these Terms of Service, please contact us through our",
};
...
const es: Dict = {
  ...
  "home.why.title": "¿Por qué elegir Unit Convertor?",
  ...
  "home.faq.subtitle": "Respuestas a preguntas comunes sobre Unit Convertor.",
  ...
  "home.faq.a1": "Unit Convertor usa aritmética de coma flotante de doble precisión y factores de conversión verificados por NIST. Soportamos hasta 12 decimales de precisión para tareas técnicas críticas.",
  "home.faq.q2": "¿Esta herramienta es gratis?",
  "home.faq.a2": "Sí, Unit Convertor es 100% gratis para estudiantes e ingenieros profesionales. Mantenemos la plataforma con anuncios mínimos y no intrusivos.",
  ...
  "home.faq.a4": "Por supuesto. Usa el enlace de contacto en el pie de página para sugerir nuevas categorías o unidades especializadas.",
  ...
  "about.h1": "Acerca de Unit Convertor",
  "about.lead": "Precisión de nivel ingenieril con simplicidad cotidiana. Construimos Unit Convertor para ser la herramienta de conversión más confiable de la web.",
  "about.mission.title": "Nuestra Misión",
  "about.mission.p1": "Unit Convertor fue creado con una sola meta: hacer la conversión de unidades sencilla, precisa y accesible para todos. Ya seas ingeniero trabajando en cálculos complejos, estudiante aprendiendo ciencias, viajero navegando medidas extranjeras o cocinero experimentando con recetas internacionales — te tenemos cubierto.",
  "about.mission.p2": "Creemos que la precisión importa. Un pequeño error de redondeo puede causar grandes problemas en ingeniería, medicina y ciencia. Por eso cada conversión en Unit Convertor se calcula con la mayor precisión y se verifica contra datos de referencia estándar.",
  ...
  "about.feedback.text": "Expandimos constantemente nuestra base de datos según las solicitudes de los usuarios. Si hay una unidad o categoría que te gustaría ver, nos encantaría saberlo. Visita nuestra",
  "about.feedback.link": "página de Contacto",
  "about.feedback.tail": "para enviarnos tus sugerencias.",

  "contact.badge": "Ponte en Contacto",
  "contact.h1": "Contacta a Unit Convertor",
  "contact.lead": "¿Tienes una pregunta, sugerencia o encontraste un problema? Nos encantaría saber de ti.",
  "contact.email.title": "Envíanos un Correo",
  "contact.email.text": "Leemos cada correo y normalmente respondemos en 24–48 horas.",

  "privacy.badge": "Privacidad",
  "privacy.h1": "Política de Privacidad",
  "privacy.lead": "Tu privacidad es importante para nosotros. Esta política explica cómo Unit Convertor maneja tus datos.",
  "privacy.s1.h": "1. Información que No Recopilamos",
  "privacy.s1.t": "Unit Convertor está diseñado con la privacidad como núcleo. No requerimos que crees cuenta, inicies sesión, ni proporciones información personal para usar nuestras herramientas. Todas las conversiones se realizan completamente en tu navegador — no se envían datos a nuestros servidores.",
  "privacy.s2.h": "2. Datos del Formulario de Contacto",
  "privacy.s2.t": "Si eliges contactarnos a través de nuestra página de Contacto, recopilamos el nombre, correo electrónico, asunto y mensaje que proporcionas. Esta información se almacena de forma segura y se usa únicamente para responder a tu consulta. No la compartimos con terceros.",
  ...
  "privacy.s5.t": "Tomamos medidas razonables para proteger los datos que proporciones. Sin embargo, ningún método de transmisión por internet es 100% seguro, y no podemos garantizar seguridad absoluta.",
  ...
  "privacy.s7.t": "Si tienes preguntas sobre esta Política de Privacidad, contáctanos a través de nuestra",
  "common.contactPage": "página de Contacto",
  "common.lastUpdated": "Última actualización:",

  "terms.badge": "Legal",
  "terms.h1": "Términos del Servicio",
  "terms.lead": "Por favor lee estos términos cuidadosamente antes de usar Unit Convertor.",
  "terms.s1.h": "1. Aceptación de los Términos",
  "terms.s1.t": "Al acceder o usar Unit Convertor, aceptas estar sujeto a estos Términos del Servicio. Si no aceptas estos términos, por favor no uses nuestros servicios.",
  "terms.s2.h": "2. Descripción del Servicio",
  "terms.s2.t": "Unit Convertor proporciona herramientas gratuitas de conversión de unidades en línea. Nuestro servicio permite convertir entre varias unidades de medida en múltiples categorías incluyendo longitud, peso, temperatura, volumen, área, velocidad y más.",
  "terms.s3.h": "3. Uso del Servicio",
  "terms.s3.t": "Puedes usar Unit Convertor con fines personales, educativos y profesionales. Aceptas no:",
  ...
  "terms.s4.t": "Aunque nos esforzamos por la máxima precisión, Unit Convertor se proporciona \"tal cual\" sin garantías de ningún tipo. Los factores de conversión se basan en datos de referencia estándar, pero no podemos garantizar que todas las conversiones sean 100% precisas en cada contexto. Para aplicaciones críticas (médicas, de ingeniería, financieras), verifica los resultados con fuentes autorizadas.",
  "terms.s5.h": "5. Limitación de Responsabilidad",
  "terms.s5.t": "En la mayor medida permitida por la ley, Unit Convertor y sus operadores no serán responsables por daños directos, indirectos, incidentales, especiales o consecuentes que surjan de tu uso o incapacidad para usar el servicio.",
  "terms.s6.h": "6. Propiedad Intelectual",
  "terms.s6.t": "Todo el contenido de Unit Convertor, incluyendo texto, gráficos, logos y software, es propiedad de Unit Convertor o sus licenciantes y está protegido por leyes de derechos de autor y propiedad intelectual.",
  ...
  "terms.s8.t": "Estos términos se regirán e interpretarán de acuerdo con las leyes aplicables en la jurisdicción donde opera Unit Convertor, sin tener en cuenta los principios de conflicto de leyes.",
  "terms.s9.h": "9. Contacto",
  "terms.s9.t": "Para preguntas sobre estos Términos del Servicio, contáctanos a través de nuestra",
};
...
const hi: Dict = {
  ...
  "home.why.title": "Unit Convertor क्यों चुनें?",
  ...
  "home.faq.subtitle": "Unit Convertor के बारे में सामान्य प्रश्नों के उत्तर।",
  ...
  "home.faq.a1": "Unit Convertor डबल-प्रिसिजन फ्लोटिंग-पॉइंट अंकगणित और NIST-सत्यापित रूपांतरण कारकों का उपयोग करता है। महत्वपूर्ण कार्यों के लिए 12 दशमलव स्थानों तक की सटीकता।",
  "home.faq.q2": "क्या यह उपकरण मुफ्त है?",
  "home.faq.a2": "हाँ, Unit Convertor छात्रों और पेशेवर इंजीनियरों के लिए 100% मुफ्त है। हम न्यूनतम, गैर-आक्रामक विज्ञापनों के माध्यम से प्लेटफ़ॉर्म चलाते हैं।",
  ...
  "home.faq.a4": "बिल्कुल। फुटर में संपर्क लिंक का उपयोग करके नई श्रेणियाँ या विशेष इकाइयाँ सुझाएँ।",
  ...
  "about.h1": "Unit Convertor के बारे में",
  "about.lead": "इंजीनियरिंग-स्तर की सटीकता रोज़मर्रा की सादगी से मिलती है। हमने Unit Convertor को वेब पर सबसे विश्वसनीय इकाई रूपांतरण उपकरण बनाया है।",
  "about.mission.title": "हमारा मिशन",
  "about.mission.p1": "Unit Convertor एक ही लक्ष्य के साथ बनाया गया था: इकाई रूपांतरण को सभी के लिए आसान, सटीक और सुलभ बनाना। चाहे आप जटिल गणनाओं पर काम करने वाले इंजीनियर हों, विज्ञान सीखने वाले छात्र हों, विदेशी मापों से जूझ रहे यात्री हों, या अंतरराष्ट्रीय व्यंजनों के साथ प्रयोग कर रहे रसोइए — हम आपकी मदद के लिए हैं।",
  "about.mission.p2": "हम मानते हैं कि सटीकता मायने रखती है। एक छोटी सी राउंडिंग त्रुटि इंजीनियरिंग, चिकित्सा और विज्ञान में बड़ी समस्याएँ पैदा कर सकती है। इसीलिए Unit Convertor पर हर रूपांतरण उच्चतम सटीकता के साथ की जाती है।",
  ...
  "about.feedback.text": "हम उपयोगकर्ता अनुरोधों के आधार पर अपने कन्वर्टर डेटाबेस का लगातार विस्तार कर रहे हैं। यदि कोई इकाई या श्रेणी जोड़ना चाहते हैं, तो हमें बताएँ। हमारे",
  "about.feedback.link": "संपर्क पृष्ठ",
  "about.feedback.tail": "पर जाकर अपने सुझाव भेजें।",

  "contact.badge": "संपर्क में रहें",
  "contact.h1": "Unit Convertor से संपर्क करें",
  "contact.lead": "कोई प्रश्न, सुझाव है या समस्या मिली? हम आपसे सुनना चाहेंगे।",
  "contact.email.title": "हमें ईमेल करें",
  "contact.email.text": "हम हर ईमेल पढ़ते हैं और आमतौर पर 24–48 घंटों में जवाब देते हैं।",

  "privacy.badge": "गोपनीयता",
  "privacy.h1": "गोपनीयता नीति",
  "privacy.lead": "आपकी गोपनीयता हमारे लिए महत्वपूर्ण है। यह नीति बताती है कि Unit Convertor आपके डेटा को कैसे संभालता है।",
  "privacy.s1.h": "1. जानकारी जो हम एकत्र नहीं करते",
  "privacy.s1.t": "Unit Convertor गोपनीयता को मूल में रखकर डिज़ाइन किया गया है। हमारे उपकरणों का उपयोग करने के लिए आपको खाता बनाने, साइन इन करने या कोई व्यक्तिगत जानकारी देने की आवश्यकता नहीं है। सभी रूपांतरण पूरी तरह आपके ब्राउज़र में होते हैं।",
  "privacy.s2.h": "2. संपर्क फॉर्म डेटा",
  "privacy.s2.t": "यदि आप संपर्क पृष्ठ के माध्यम से हमसे संपर्क करते हैं, तो हम आपका नाम, ईमेल, विषय और संदेश एकत्र करते हैं। यह जानकारी केवल आपकी पूछताछ का जवाब देने के लिए उपयोग होती है।",
  ...
  "privacy.s5.t": "हम संपर्क फॉर्म के माध्यम से प्रदान किए गए किसी भी डेटा की सुरक्षा के लिए उचित उपाय करते हैं। हालाँकि, इंटरनेट पर संचरण का कोई भी तरीका 100% सुरक्षित नहीं है।",
  ...
  "privacy.s7.t": "यदि इस गोपनीयता नीति के बारे में कोई प्रश्न हैं, तो कृपया हमारे",
  "common.contactPage": "संपर्क पृष्ठ",
  "common.lastUpdated": "अंतिम अद्यतन:",

  "terms.badge": "कानूनी",
  "terms.h1": "सेवा की शर्तें",
  "terms.lead": "कृपया Unit Convertor का उपयोग करने से पहले इन शर्तों को ध्यान से पढ़ें।",
  "terms.s1.h": "1. शर्तों की स्वीकृति",
  "terms.s1.t": "Unit Convertor का उपयोग करके आप इन सेवा शर्तों से बंधे होने के लिए सहमत होते हैं। यदि आप इन शर्तों से सहमत नहीं हैं, तो कृपया हमारी सेवाओं का उपयोग न करें।",
  "terms.s2.h": "2. सेवा का विवरण",
  "terms.s2.t": "Unit Convertor मुफ्त ऑनलाइन इकाई रूपांतरण उपकरण प्रदान करता है। हमारी सेवा आपको लंबाई, वजन, तापमान, आयतन, क्षेत्रफल, गति और अधिक श्रेणियों में रूपांतरण की अनुमति देती है।",
  "terms.s3.h": "3. सेवा का उपयोग",
  "terms.s3.t": "आप Unit Convertor का व्यक्तिगत, शैक्षिक और पेशेवर उद्देश्यों के लिए उपयोग कर सकते हैं। आप सहमत हैं कि:",
  ...
  "terms.s4.t": "हालाँकि हम अधिकतम सटीकता का प्रयास करते हैं, Unit Convertor \"जैसा है\" प्रदान किया जाता है। महत्वपूर्ण अनुप्रयोगों (चिकित्सा, इंजीनियरिंग, वित्तीय) के लिए, कृपया आधिकारिक स्रोतों से परिणाम सत्यापित करें।",
  "terms.s5.h": "5. दायित्व की सीमा",
  "terms.s5.t": "कानून द्वारा अनुमत अधिकतम सीमा तक, Unit Convertor और इसके संचालक सेवा के उपयोग से उत्पन्न किसी भी प्रत्यक्ष या अप्रत्यक्ष क्षति के लिए उत्तरदायी नहीं होंगे।",
  "terms.s6.h": "6. बौद्धिक संपदा",
  "terms.s6.t": "Unit Convertor की सभी सामग्री, टेक्स्ट, ग्राफिक्स, लोगो और सॉफ़्टवेयर सहित, Unit Convertor या इसके लाइसेंसकर्ताओं की संपत्ति है।",
  ...
  "terms.s8.t": "ये शर्तें उस क्षेत्राधिकार के लागू कानूनों के अनुसार शासित होंगी जहाँ Unit Convertor संचालित होता है।",
  "terms.s9.h": "9. संपर्क",
  "terms.s9.t": "इन सेवा शर्तों के बारे में प्रश्नों के लिए, कृपया हमारे",
};
